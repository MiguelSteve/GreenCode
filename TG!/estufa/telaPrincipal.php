...
try
{
    ...
    $conectaBD = new PDO("mysql:host=177.153.63.45;port=3306;dbname=estufa", "estufa", "TgF@da3");
...
<body class="tela-principal" style="background-image: url(fundoLogin/telaPrinc.png);">    
    ...
    <div class="menu2">
        ...
        <img src="fundoLogin/greenhouse.png" alt="Ícone de perfil">
        ...
        <a href="alteraPlanta.php"><input type="button" value="Editar Estufa" name="btnMonitorar" id="btn_monitorar"></a>
